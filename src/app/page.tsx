...
export default function Home() {
  ...
  return (
    <main className={`relative bg-[#1a0b2e] text-white ${!room ? "h-[100dvh] overflow-hidden touch-none" : "min-h-screen overflow-hidden"}`}>
      ...
      <section className={`relative mx-auto flex max-w-5xl flex-col px-4 md:px-6 lg:px-8 ${!room ? "min-h-[100svh] justify-center py-0" : "min-h-screen justify-center py-4"}`}>
        <div className={`grid gap-5 ${room ? "mt-2 lg:items-start lg:grid-cols-[0.85fr_1.15fr]" : "flex-1 items-center content-center lg:grid-cols-1 lg:place-items-center"}`}>
