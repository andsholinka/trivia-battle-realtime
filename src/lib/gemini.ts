...
export async function generateTriviaQuestions(category: string, count = 5) {
  ...
  if (questions.length !== count) {
    throw new Error(`Gemini tidak mengembalikan ${count} soal valid.`);
  }
